...
export const MOVE_SPEED = 7; // Increased speed for larger scale
...
export const DAMAGE_PUNCH = 8;
export const DAMAGE_KICK = 12;
export const DAMAGE_TAKEDOWN = 25; // High damage slam

export const STAMINA_COST_PUNCH = 10;
export const STAMINA_COST_KICK = 20;
export const STAMINA_COST_TAKEDOWN = 35; // Expensive move
...
export const BLOCK_COOLDOWN = 10;
